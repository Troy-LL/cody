...
| **Stub requirement** | Downstream stubs may raise until Task 2 fixture stubs; orchestration must tolerate stubs. |
| **Test command** | `python -m pytest orchestration/tests -q` (owner adds tests). |
